...
async def on_plug_in_callback_query_handler(event):
    ...
    buttons = [
        (Button.inline(text="🇮🇶︙إسـتـفـسـار مـعـيـن .", data="to_enquire_something"),),
        (Button.inline(text="🇮🇶︙طـلـب مـعـيـن .", data="to_request_something"),),
        (Button.inline(text="🇮🇶︙الـدردشـة .", data="to_chat_with_my_master"),),
        (Button.inline(text="🇮🇶︙إزعـاج الـمـالـڪ .", data="to_spam_my_master_inbox"),),
    ]
...
async def approve_p_m(event):
    ...
    if len(approved_users) > 0:
        ...
        APPROVED_PMs = "🇮🇶 ⦙   لـم تـوافـق عـلـى أي شـخـص مـسـبـقـاً "

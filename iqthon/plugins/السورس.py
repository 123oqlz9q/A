...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "أهلا بك عزيزي المطور في السورس الخاص بك"
...
fahs = """🇮🇶 : المطور  {my_mention}  𖡺
🇮🇶 : الوقت  {TM}  𖡺
🇮🇶 : بوتي  {tg_bot}  𖡺
🇮🇶 : البنك  {ping}  𖡺
🇮🇶 : الأصدار 7.6  𖡺"""
@iqthon.on(admin_cmd(pattern="رابط الففنقىتنصيب(?: |$)(.*)"))    
async def source(e):
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "هذا هو السورس الخاص بك"
...
async def _(event):
    ...
    OUTPUT = (f"🇮🇶︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب السورس :**\n\n{o}")
            ...
            while flag:
                try:
                    ...
                    if check > 5:
                        break
            if BOTLOG:
                await iqthon.send_message(                    BOTLOG_CHATID,                    f"**🇮🇶︙   تحـميل المـلف  : `{os.path.basename(downloaded_file_name)}`  تـم بنجـاح ✔️**",                )
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث السورس انتظر من 5 الى 10 دقائق")
    try:
    ...
    try:
        ...
        LOGS1.error(e)
@iqthon.on(admin_cmd(pattern="مساىبهثحعده(?:\s|$)([\s\S]*)"))
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**🇮🇶︙  📑 يرجى الكتابة بشكل صحيح")
    ...
    if exe == "get":
        ...
        try:
            ...
            if variable in heroku_var:
                return await ics.edit(                    "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑽𝑨𝑹𝑺 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"                    f"\n **⌔** `{variable} = {heroku_var[variable]}` .\n"                )
            return await ics.edit(                "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑽𝑨𝑹𝑺 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"                f"\n **⌔ خطا :**\n-> {variable} غيـر موجود. "            )
        except IndexError:
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        query = iqthon.text
        await bot.get_me()
        if query.startswith("تنانصيب") and iqthon.query.user_id == bot.uid:
...
@bot.on(admin_cmd(outgoing=True, pattern="تنصهفيب"))
...
"""**قائمـه ﭑوامـر السـۅࢪس الخــاص بــك**
**✛━━━━━━━━━━━━━✛**
(`.م1`) - ﭑوامࢪ اެلسورس ♰
(`.م2`) - ﭑوامࢪ اެلحساب ♰
(`.م3`) -  ﭑوامࢪ اެلمجموعهہَ ♰
(`.م4`) - ﭑوامࢪ اެلمجموعهہَ ² ♰
(`.م5`) - ﭑوامࢪ اެلصيغہَ ۅ اެلجهات ♰
(`.م5`) - حمايهہَ خاصہَ ولتلڪࢪاف ♰
(`.م6`) - ﭑوامࢪ اެلألعاب ♰
(`.م7`) - ﭑوامࢪ اެلميمز ♰
(`.م8`) - ﭑوامࢪ اެلتسليه ۅ اެلتحشيش ♰
...
✛━━━━━━━━━━━━━✛
¹ ⦙  لتغير كليشة الفحص والسورس  كاملة : 

`.اضف فار ALIVE_TELETHONIQ` + كليشه مع المتغيرات 

🇮🇶 : متغيرات كليشه الفحص والسورس   : 
...
² ⦙ لتغيير صوره أو فيديو أم الفحص والسورس : 

`.اضف فار ALIVE_PIC` + رابط تليجراف الصورة او الفيديو 

للحصول على تيلجراف للصورة : .تليجراف ميديا + الرد على الصورة أو الفيديو 

✛━━━━━━━━━━━━━✛ 

³ ⦙ لتغير كليشه رسالة حماية الخاص : 

`.اضف فار PM_TEXT` + الكليشة 

1 - {mention} يكتب اسم الشخص
2 - {warns}/{totalwarns} لـ عدد التحذيرات 

✛━━━━━━━━━━━━━✛ 

⁴ ⦙ لتغيير أو اضافة صورة الى حماية الخاص : 

`.اضف فار PM_PIC` + رابط تليجراف الصورة او الفيديو 

امر تحويل الصورة والفيديو لرابط :  `.تليجراف ميديا` 

✛━━━━━━━━━━━━━✛ 

⁵ ⦙ لتغير عدد التحذيرات برسالة الحماية الخاص : 
...
- أرسل :  `.اضف فار DEFAULT_BIO` + الجمله
- أرسل :  `.تحديث` 
...
⁸ ⦙ لتغير خط الوقت في الاسم الوقتي و النبذه الوقتية : 

1 - لأضـافة هـذا الخط : ( 𝟎𝟏𝟐𝟑𝟒𝟓𝟔𝟕𝟖𝟗 ) 
أرسـل ⇦ ( `.اضف فار FONTS_AUTO font1` ) 

2 - لأضـافة هـذا الخط : ( 𝟬𝟭𝟮𝟯𝟰𝟱𝟲𝟳𝟴𝟵 ) 
أرسـل ⇦ (`.اضف فار FONTS_AUTO font2` ) 

3 - لأضـافة هـذا الخط : (０１２３４５６８９) 
أرسـل ⇦ ( `.اضف فار FONTS_AUTO font3` ) 

4 - لأضـافة هـذا الخط : ( 𝟙𝟚𝟛𝟜𝟝𝟞𝟟𝟠𝟡𝟘 ) 
أرسـل ⇦ ( `.اضف فار FONTS_AUTO font4` ) 

5 - لأضـافة هـذا الخط : ( 𝟢𝟣𝟤𝟥𝟦𝟧𝟨𝟩𝟪𝟫 ) 
أرسـل ⇦ ( `.اضف فار FONTS_AUTO font5` ) 

6 - لأضـافة هـذا الخط : ( ①②③④⑤⑥⑦⑧⑨⓪ )
أرسـل ⇦  ( `.اضف فار FONTS_AUTO font6` ) 

7 - لأضـافة هـذا الخط : ( ❶❷❸❹❺❻❼❽❾⓿ )
أرسـل ⇦  ( `.اضف فار FONTS_AUTO font7` ) 

8 - لأضـافة هـذا الخط : ( 0123456789 )
أرسـل ⇦  ( `.اضف فار FONTS_AUTO font8` ) 

9 - لأضـافة هـذا الخط : ( ₁ ₂ ₃ ₄ ₅ ₆ ₇ ₈ ₉ ₀ )
أرسـل ⇦  ( `.اضف فار FONTS_AUTO font9` ) 

10 - لأضـافة هـذا الخط : ( 𝟶𝟷𝟸𝟹𝟺𝟻𝟼𝟽𝟾𝟿 )
أرسـل ⇦   (`.اضف فار FONTS_AUTO font10`) 

11 - لأضـافة هـذا الخط : ( ١٢٣٤٥٦٧٨٩٠ )
أرسـل ⇦  ( `.اضف فار FONTS_AUTO font11` ) 

✛━━━━━━━━━━━━━✛ 

⁹ ⦙ لتغير الايموجي بالسورس و ايضا رمز الذي بجانب الوقتي : 
...
async def iq(event):
    await edit_or_reply(event, "**❤️‍🔥  𖡺   بصمات تحشيش 1   𖡺  :**\n\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص1`)   ⦙   ابو  عباس  لو  تاكل  خره\n(`.ص2`)   ⦙   استمر  نحن  معك\n(`.ص3`)   ⦙   افحط  بوجه\n(`.ص4`)   ⦙   اكعد  لا  اسطرك  سطره  العباس\n(`.ص5`)   ⦙   اللهم  لا  شماته\n(`.ص6`)   ⦙   امرع  دينه\n(`.ص7`)   ⦙   امشي  بربوك\n(`.ص8`)   ⦙   انت  اسكت  انت  اسكت\n(`.ص9`)   ⦙   انت  سايق  زربه\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص10`)   ⦙   اوني  تشان\n(`.ص11`)   ⦙   برافو  عليك  استادي \n(`.ص12`)   ⦙   بلوك  محترم\n(`.ص13`)   ⦙   بووم  في  منتصف  الجبهة \n(`.ص14`)   ⦙   بيتش \n(`.ص15`)   ⦙   تخوني  ؟\n(`.ص16`)   ⦙   تره  متكدرلي\n(`.ص17`)   ⦙   تعبان  اوي\n(`.ص18`)   ⦙   تكذب\n(`.ص19`)   ⦙   حسبي  الله\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص20`)   ⦙   حشاش \n(`.ص21`)   ⦙   حقير  \n(`.ص22`)   ⦙   خاص  \n(`.ص23`)   ⦙   خاله  ما  تنامون  \n(`.ص24`)   ⦙   خرب  شرفي  اذا  ابقى  بالعراق \n(`.ص25`)   ⦙   دكات  الوكت  الاغبر  \n(`.ص26`)   ⦙   ررردح  \n(`.ص27`)   ⦙   سلامن  عليكم  \n(`.ص28`)   ⦙   بوم منتصف جبهه   \n(`.ص29`)   ⦙   شكد  شفت  ناس  مدودة\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻")
@iqthon.on(admin_cmd(pattern="م22(?: |$)(.*)"))    
async def iq(event):
    await edit_or_reply(event, "**❤️‍🔥  𖡺   بصمات تحشيش 2   𖡺  :**\n\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص30`)   ⦙  شلون  ، \n(`.ص31`)   ⦙  صح  لنوم  \n(`.ص32`)   ⦙  صمت  \n(`.ص33`)   ⦙  ضحكة  مصطفى  الحجي  \n(`.ص34`)   ⦙  طماطه  \n(`.ص35`)   ⦙  طيح  الله  حضك  \n(`.ص36`)   ⦙  فاك  يوو  \n(`.ص37`)   ⦙  اني فرحان وعمامي فرحانين\n(`.ص38`)   ⦙  لا  تضل  تضرط  \n(`.ص39`)   ⦙  لا  تقتل  المتعه  يا  مسلم  \n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص40`)   ⦙  لا  مستحيل  \n(`.ص41`)   ⦙  لا  والله  شو  عصبي  \n(`.ص42`)   ⦙  لش  \n(`.ص43`)   ⦙  لك  اني  شعليه  \n(`.ص44`)   ⦙  ما  اشرب  \n(`.ص45`)   ⦙  مع  الاسف  \n(`.ص46`)   ⦙  مقتدى  \n(`.ص47`)   ⦙  من  رخصتكم  \n(`.ص48`)   ⦙  منو  انت  \n(`.ص49`)   ⦙  منورني  \n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص50`)  ⦙  نتلاكه  بالدور  الثاني \n(`.ص51`)  ⦙  نستودعكم  الله  \n(`.ص52`)  ⦙  ها  شنهي  \n(`.ص53`)  ⦙  ههاي  الافكار  حطها ب\n(`.ص54`)  ⦙  ليش شنو سببها ليش\n(`.ص55`)  ⦙  يموتون  جهالي\n(`.ص56`)  ⦙  اريد انام\n(`.ص57`)  ⦙  افتحك فتح\n(`.ص58`)  ⦙  اكل خره لدوخني\n(`.ص59`)  ⦙  السيد شنهو السيد\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص60`)  ⦙  زيج2\n(`.ص61`)  ⦙  زيج لهارون\n(`.ص62`)  ⦙  زيج الناصرية\n(`.ص63`)  ⦙  راقبو اطفالكم\n(`.ص64`)  ⦙  راح اموتن\n(`.ص65`)  ⦙  ذس اس مضرطة\n(`.ص66`)  ⦙  دروح سرسح منا\n(`.ص67`)  ⦙  خويه ما دكوم بيه\n(`.ص68`)  ⦙  خلصت تمسلت ديلة كافي انجب\n(`.ص69`)  ⦙  بعدك تخاف\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻")
@iqthon.on(admin_cmd(pattern="م23(?: |$)(.*)"))    
async def iq(event):
    await edit_or_reply(event, "**❤️‍🔥  𖡺   بصمات تحشيش 3   𖡺  :**\n\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص70`)  ⦙  بسبوس\n(`.ص71`)  ⦙  اني بتيتة كحبة\n(`.ص72`)  ⦙  انعل ابوكم لابو اليلعب وياكم طوبة\n(`.ص73`)  ⦙  انت شدخلك\n(`.ص74`)  ⦙  انا ماشي بطلع\n(`.ص75`)  ⦙  امداك وامده الخلفتك\n(`.ص76`)  ⦙  امبيههههه\n(`.ص77`)  ⦙  هدي بيبي\n(`.ص78`)  ⦙  هاه صدك تحجي\n(`.ص79`)  ⦙  مو كتلك رجعني\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص80`)  ⦙  مامرجية منك هاية\n(`.ص81`)  ⦙  ليش هيجي\n(`.ص82`)  ⦙  كـــافـي\n(`.ص83`)  ⦙  كس اخت السيد\n(`.ص84`)  ⦙  شنو كواد ولك اني هنا\n(`.ص85`)  ⦙  شجلبت\n(`.ص86`)  ⦙  شبيك وجه الدبس\n(`.ص87`)  ⦙  سييييي\n(`.ص88`)  ⦙  زيجج1\n(`.ص89`)  ⦙  يموتون جهالي\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n(`.ص90`)  ⦙  ياخي اسكت اسكت\n(`.ص91`)  ⦙  وينهم\n(`.ص92`)  ⦙  هيلو سامر وحود\n(`.ص93`)  ⦙  هو\n(`.ص94`)  ⦙  ههاي الافكار حطها\n                                                       𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n")
